...
export default function VisitorsDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black/85 via-zinc-950/60 to-zinc-900/85 px-6 pb-16 pt-36 text-zinc-100 sm:px-10 sm:pt-40 lg:px-16 lg:pt-44">
